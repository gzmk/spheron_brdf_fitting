...
writetable(T,'/scratch/gk925/spheron_brdf_fitting/gloss100_fit/sphere_3params_Conditions.txt','Delimiter','\t')
...
% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/spheron_brdf_fitting/gloss100_fit');
...
imPath = ['/scratch/gk925/spheron_brdf_fitting/gloss100_fit/', hints.recipeName, '/renderings/Mitsuba/spheron_sphere6-001.mat']
