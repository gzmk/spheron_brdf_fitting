...
writetable(T,'/scratch/gk925/spheron_brdf_fitting/gloss40_fit/sphere_3params_Conditions.txt','Delimiter','\t')
...
% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/spheron_brdf_fitting/gloss40_fit');
