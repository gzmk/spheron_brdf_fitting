...
writetable(T,'/scratch/gk925/spheron_brdf_fitting/gloss0_fit/sphere_3params_Conditions.txt','Delimiter','\t')
...
% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/spheron_brdf_fitting/gloss0_fit');
...
imPath = ['/scratch/gk925/spheron_brdf_fitting/gloss0_fit/', hints.recipeName, '/renderings/Mitsuba/spheron_sphere6-001.mat']
...
cx=180;cy=202;ix=380;iy=380;r1=115;r2=125; 
[x,y]=meshgrid(-(cx-1):(ix-cx),-(cy-1):(iy-cy));
c_mask=(((x.^2.*r1^2)+(y.^2.*r2^2))<=r1^2*r2^2);

load('registered0_2.mat') % make this a variable
photo = renderRegisteredAdjusted6;
% imshow(c_mask.*photo)
newmask = mask&c_mask;
